...
export default function ChatbotPage() {
  ...
  return (
    <div className="flex h-[calc(100vh-64px)] flex-col bg-gradient-to-b from-blue-50 to-white">
      {/* HEADER */}
      <header className="border-b border-blue-100 bg-white px-6 py-4 shadow-sm">
